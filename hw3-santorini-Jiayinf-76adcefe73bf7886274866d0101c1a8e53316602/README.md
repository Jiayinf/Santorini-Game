...
TO run it:
first run the back end file "Santorini.jave", then run the front end by first calling 
"npm install", then calling "npm start",
goto the http://localhost:3000/
this will give you the Santorini game:

Notice: 
orange stands for level 1
green stands fro level 2
yellow stands for level 3
pink stands for level 4 (I.E. finish building with a dome)

1. Select two gods in sequence at the bottom button bar area (The 1st god you choose will automatically be assigned to playerA and the 2nd one will be assigned to playerB)
   Human is considered as "NO GOD POWER"!

2. Then starting by placing the initialize position first, then move and build and switch rounds.

3. For some gods who have additional builds or moves or power, notice that there are "Yes" and "No" option buttons right below the message area. Only allow to choose once!
   
   Demeter:
   For additional build: if choose "No" to skip, just then randomly click a cell to go to next phase. if choose "Yes", just go on with your additional build/move.
   Clicking anywhere instead of the "Yes" button will be considered as giving up your extra builds!

   Atlas:
   For building Dome or not option: First click the cell you want to build. Then still the top option bar, choose "Yes" to build a dome, then click the cell you want to buidl again, to finally 
   certificate your build. If choose "No", still click the cell you want to do a normal build again to certificate your normal build.
   Clicking anywhere instead of the "Yes" button will be considered as giving up your extra power!

   Hephaestus:
   For additional build: if choose "No" to skip, just then randomly click a cell to go to next phase. if choose "Yes", just go on with your additional build/move by clicking on the position you build 
   just now. Since according to the rule, you are only allowed to build one additional block on top of your first block, clicking somewhere else will give you a "illegal build" feedback.
   Clicking anywhere instead of the "Yes" button will be considered as giving up your extra builds!

   Artemis:
   For additional move: if choose "No" to skip, just then randomly click a cell to go to next phase. if choose "Yes", just go on with your additional build/move.
   Clicking anywhere instead of the "Yes" button will be considered as giving up your extra move!
